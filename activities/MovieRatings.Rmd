...
Yes, the observed frequency is different from the expected frequency. There in not too much of a difference the only oticeable differences are in the 5-star and 2-star rows.
...
If the calculated chi-square statistic (9.95) is greater than the right-tail critical value (9.48), we reject the null hypothesis and conclude that the observed frequencies are significantly different from the expected frequencies.
...
I would reject the null hypothesis becasue the calculated chi-square statistic (9.95), is greater than the right-tail critical value (9.48). This means that the observed frequencies are significantly different from the expected frequency. 
