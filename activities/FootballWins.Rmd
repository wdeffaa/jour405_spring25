...
Personally, I believe that this is somewhat a useful model, despite the typical prediction by the model deviating from the actual number of wins by around 2 wins. The F-statistic of 15.44 shows that overall, this model is still statistically signifigant.
...
The factor that had the most impact on wins was points scored and the factor that had the lowest correlation to wins was yards gained.  
...
I would say that when comparing which factors impacted wins for a team or a game the most, points scored had a significant impact on the amount of wins a team had, while yards gained, did not have too much of an impact on wins, but did have a major impact on points scored, which then impacted wins. 
