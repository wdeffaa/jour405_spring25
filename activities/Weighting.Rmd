...
1. What is the range of weights in this dataset?
  ...
  Most of the rage of weight is toward the 1, meaning most people in the surveys are counted as one, however, there is a tail to the right in which a small amount of people have their vote counted twice, due to being underrepresented.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
  
  When a respondant has a weight of 0.23, it means they are overrepresented and their vote is counted less than 1, however, when they have a weight of 3.04, that means they are underrepresented, meaning their vote is counted more than just one vote. 

3. Why might some respondents be weighted more heavily than others?
  
  Some respondants may be weighed more than others if their group as a whole is underrepresented, and to compensate for the lack of response in the survey from said group, their votes are counted as more than 1.
...
1. Which voter category shows the biggest difference between weighted and unweighted results?
  ...
  The voter category that shows the largest difference between weighted and unweighted results is the rarely/never category.

2. How might these differences affect reporting on likely voter turnout?
  
  The differences might affect reporting on likely voter turnout by possibly making polls more accurate by taking the weight of how much everyones vote is represneted, making the data more equal for every category, improving polling and voter turnout estimates. 
...
3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample?
  ...
  This difference exists because some polls may weigh some groups that may be underrepresented higher than other groups that are overrepresented, however, when taking away the weight of these votes, the difference comes up. This tells us that rarely/never voters are very unrepresented compared to those who always vote who are greatly represented.
