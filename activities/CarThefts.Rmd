...
```{r}
car_thefts %>% summarize(standardd = sd(count))
...
car_thefts %>% 
  ggplot(aes(x = count)) +
  geom_histogram(binwidth = 1.0, fill = "gray", color = "black") +
  labs(title = "Number of Car Thefts", x = "Count", y = "Frequency")
```
...
The distribution is relatively normal with a little skew toward the positive side of the data with most of the data being toward higher counts of car thefts with higher frequency.
