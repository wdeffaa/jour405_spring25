...
There seems to be no real correlation between goal differential and fouls as all of the data points seem to be in one blob-like formation with everything being very even with each other.
