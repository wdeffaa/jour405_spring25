...
There seems to be no real relationship between FARMS percentage and math test scores as many of the scatterplots are all over the place.
...
The nature of this relationship between FRAMS percentage and math test suggests that this model would not be reliable to use as there are major residuals in the Min and Max, with the Min being almost 35 points off ad the Max being 31 points off.
...
Some of the largest differences between the predicted results and the actual math score can be as high as 45 and 30 percent. 
...
Conclusions I would draw from this model's results would be that there seems to be no real relationship between FARMS percentages and math test scores and that there could be many other different factors that influence these results. These results (or lack there of) would cause me to look for another story pitch and look into what other possible factors could contribute to this model and data results. 
