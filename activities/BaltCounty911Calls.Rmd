...
The horizontal line that I would draw above to indicate what number of calls would be too much and therefore be unusual would be at 17. On the other end, for the lower line, I would draw it at 6.
...
The number for unusually high call counts per days in quite lower than what I put in task 3, with the number being 11 instead of 17 which I said for task 3. For the unusually low number of calls per-day, I was righ on at 7 calls per day. 
...
I would describe these days by saying that they are the highest days where the number of 911 calls per-day for drug overdoses rise from their average.  
...
I would try and investigate the date of 10/04/2022 because not only is it the highest day of calls made in this list, it also has the highest z-score, making this a very unusual event. My next steps would be to see if there were any unusual events taht took place on this day that may have caused this spike. I would tell my editor the significantly high z-score on this day and suggest we dig further into seeing if there is something that happened. 
