...
```{r}
vbmatches <- read_csv("https://raw.githubusercontent.com/dwillis/NCAAWomensVolleyballData/refs/heads/main/data/ncaa_womens_volleyball_matchstats_2024.csv")
```
...
Marylnd is in the 95th percentile in total aces across colleges around the nation despite their 14-17 record. It joins other schools such as Creighton and Merrimack, who went 32-3 and 10-21 respectively.
