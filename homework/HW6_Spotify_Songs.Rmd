...
```{r}
spotify_songs %>% summarize(sd_danceability = sd(danceability), mean = mean(danceability))
```
...
The distribution seems to be skewed towards 0.5 and 1.0 in terms of Danceability Score, the mean and distribution tell us that the average song in this dataset is danceable.
