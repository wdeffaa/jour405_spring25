...
Overall, I think that the difference between the expected and observed frequencies is meaningful. While some of the differences are not too much, the highest letter grade, A, has a relatively large difference of 20, compared to the other differences.
...
Yes we do, if the calculated chi-square statistic is greater than the critical value we reject the null hypothesis at the 0.05 alpha level.
...
There are some notable differences in the expected and observed frequencies, for example, there is a large gap in these frequencies in the "A" letter grade and the "C" letter grade. One question I would ask about these differences would be if there was a possible grading curve or extra credit that led to more students getting an "A" letter grade than expected. 
